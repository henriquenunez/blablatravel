...
CREATE TABLE RELATO_DE_VIAGEM (
    ...
    -- TODO CHECK tem atendente se status EM_ANALISE ou RESOLVIDO
);
...
CREATE TABLE RELATO_DE_VIAGEM_DENUNCIA (
    ...
    -- TODO Conferir se relato é do tipo DENUNCIA
    -- Conferir se o usuario denunciado estava no passeio
    -- TODO nao pode denunciar a si mesmo
);
...
CREATE TABLE AVALIACAO_TURISTA (
    ...
    CONSTRAINT CK_AVALIACAO_TURISTAA_NOTA CHECK(NOTA>=0 AND NOTA<=5) 
);
