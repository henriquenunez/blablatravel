...
CREATE TABLE PASSEIO_ATRACAO (
    ...
    CONSTRAINT PK_PASS_ATR PRIMARY KEY (GUIA, DATA, ATRACAO),
    CONSTRAINT FK_PASS_ATR_G FOREIGN KEY (GUIA) REFERENCES PASSEIO (GUIA),
    CONSTRAINT FK_PASS_ATR_D FOREIGN KEY (GUIA) REFERENCES PASSEIO (DATA),
    CONSTRAINT FK_PASS_ATR_A FOREIGN KEY (GUIA) REFERENCES ATRACAO (NOME)
);
